...
class SaleController extends Controller
{
    ...
    public function store(Request $request)
    {
       ...
       $draft = SaleDraft::with([
        ...
        if ($draft->status === 'held') {
            return back()->with(
                'error',
                'This draft is on hold. Please resume it before completing the sale.'
            );
        }
        ...
        try {
            ...
            NotificationHelper::create(
                ...
                message: 'Receipt ' . $sale->receipt_number . ' completed successfully.',
                type: 'success',
                role: 'Cashier'
            );
    ...
    */
    ...
    private function processSaleItems(
        Sale $sale,
        SaleDraft $draft
    )
